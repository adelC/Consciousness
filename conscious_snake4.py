...
while True:
    ...
    the_neurons_full = [dafood, (foodx, foody),head_position, head_direction]
    ...
    # ### ATTENTION GUIDANCE -- THIS NEEDS WORK !!!!
    the_list_comparison = {}
    ...
    constrained_neurons = [the_choice, the_choice2, (current_energy+sum(food_energy)), first_frame, day]
